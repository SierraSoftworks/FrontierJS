...
BasicCache.prototype.store = function(username, expires, value, callback) {
	if(/^[!+-]/.test(username))
...
BasicCache.prototype.storeMap = function(map, expires, callback) {
...
BasicCache.prototype.fetch = function(username, callback) {
